...
const mainMenuBn = new Button('Main Menu', window.innerWidth / 2 - 50, H - 20, '130px', '35px', "blue", '20px');
const gamePlayBn = new Button('Play Game', window.innerWidth / 2 - 60, H - 35, '130px', '45px', "blue", '20px');
const exitBn = new Button('EXIT', window.innerWidth / 2 - 450, H - 15, '80px', '25px', "grey", '',);
