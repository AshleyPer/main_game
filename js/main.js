...
function drawGameplay() {
  ...
  if(ninja.ninjaAttack){
    ninja.ninjaAttack.collide(enemy1.enemySprite1,enemy1Fight);//start of fighting code
    ninja.ninjaAttack.collide(enemy2.enemySprite2,enemy2Fight);
    ninja.ninjaAttack.collide(enemy3.enemySprite3,enemy3Fight);
    ninja.ninjaAttack.collide(enemyB.enemySprite4,enemyBFight);
  }

  enemy1.enemySprite1.collide(ninja.ninjaSprite, enemy1.attackAnimation1);
  enemy2.enemySprite2.collide(ninja.ninjaSprite, enemy2.attackAnimation2);
  enemy3.enemySprite3.collide(ninja.ninjaSprite, enemy3.attackAnimation3);
  enemyB.enemySprite4.collide(ninja.ninjaSprite, enemyB.attackAnimationB);

  
  

  ninja.ninjaSprite.bounce(enemy1.enemySprite1, bounceBack)
  ninja.ninjaSprite.bounce(enemy2.enemySprite2, bounceBack)
  ninja.ninjaSprite.bounce(enemy3.enemySprite3, bounceBack)
  ninja.ninjaSprite.bounce(enemyB.enemySprite4, bounceBack)
...
function resetGame(){//a function to call when return to main menu after game over, or game win
  ...
  enemy1.enemySprite1.position.x = W +250;//reset enemy positions - update when finalised
  enemy1.enemySprite1.position.y = H-45;
  enemy2.enemySprite2.position.x = W +750;
  enemy2.enemySprite2.position.y = H-45;
  enemy3.enemySprite3.position.x = W +1250;
  enemy3.enemySprite3.position.y = H-45
  enemyB.enemySprite4.position.x = W +1850;
  enemyB.enemySprite4.position.y = H-45
  ...
  enemy1.enemySprite1.changeAnimation('runEast1');//reset enemy to idle
  enemy2.enemySprite2.changeAnimation('runEast2');
  enemy3.enemySprite3.changeAnimation('runEast3');
  enemyB.enemySprite4.changeAnimation('runEastB');
...
function enemy1Fight( ){//basic start function for fighting
    ...
    if (ninja.ninjaAttackOn == false){
      if(enemyHit1<20){
        ...
        enemy1.enemySprite1.position.y = -100;
        score +=5;
...
function enemy2Fight(){
  ...
  if (ninja.ninjaAttackOn == false){
    if(enemyHit2<50){
      ...
      enemy2.enemySprite2.position.y = -100;
      score += 10
    }
  }
}
...
function enemy3Fight(){
  ...
  if (ninja.ninjaAttackOn == false){
    if(enemyHit3<80){
      ...
      enemy3.enemySprite3.position.y = -100;
      score+=15
...
function enemyBFight(){
  ...
  if (ninja.ninjaAttackOn == false){
    if(enemyHitB<120){
      ...
      enemyB.enemySprite4.position.y = -100;
      score +=25;
    }
  }
}
